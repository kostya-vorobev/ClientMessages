...
QT_MOC_LITERAL(6, 56, 15) // "serverConnected"

    },
    "SocketManager\0connected\0\0disconnected\0"
    "dataReceived\0data\0serverConnected"
};
...
void SocketManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->serverConnected(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::connected)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (SocketManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::disconnected)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (SocketManager::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::dataReceived)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (SocketManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketManager::serverConnected)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject SocketManager::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_SocketManager.data,
    qt_meta_data_SocketManager,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
// SIGNAL 2
void SocketManager::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 3
void SocketManager::serverConnected()
{
